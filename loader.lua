...
local source = game:HttpGet("https://raw.githubusercontent.com/hasck777/roblox/refs/heads/main/" .. (isLimited and "source-limited.lua" or "source.lua"))
...
elseif environment == "Nihon" and not executed then
    ...
    queue_on_teleport(game:HttpGet("https://raw.githubusercontent.com/hasck777/roblox/refs/heads/main/hook.lua") .. "task.wait(5);" .. source)
