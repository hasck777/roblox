...
LPH_JIT_MAX(function() -- Main Cheat
    ...
    local pathfinding = loadstring(game:HttpGet("https://raw.githubusercontent.com/hasck777/roblox/refs/heads/main/pathfinding.lua"))() -- i didnt make this, i did fix it tho cuz pro
...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    if isfile(folderName .. "/theme.json") then
        ...
        title = (userThemeData.Title == "Wapus" and "Mkz.Shop") or userThemeData.Title
        wapus.theme = {
